...
trait CommonTypeImplicits {
  ...
  implicit val jodaLocalDateTime: MappedSimpleSerializer[String, org.joda.time.LocalDateTime] = Primitive.string.map(_.toString, org.joda.time.LocalDateTime.parse(_), null)
