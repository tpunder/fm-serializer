...
object StringMapCanBuildFromDeserializer {
  def forVector[V,Col](implicit elemDeser: Deserializer[(String,V)], valueDeser: Deserializer[V]): StringMapCanBuildFromDeserializer[V,Col] = {
    val cbf: CanBuildFrom[_,(String,V),Col] = Vector.canBuildFrom[(String,V)].asInstanceOf[CanBuildFrom[_,(String,V),Col]]
    new StringMapCanBuildFromDeserializer[V, Col]()(cbf, elemDeser, valueDeser)
  }
}

final class StringMapCanBuildFromDeserializer[V,Col](implicit cbf: CanBuildFrom[_,(String,V),Col], elemDeser: Deserializer[(String,V)], valueDeser: Deserializer[V]) extends Deserializer[Col] {
  ...
  private def readCollection(input: FieldInput): Col = {
    val builder: Builder[(String,V),Col] = cbf()
